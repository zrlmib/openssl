...
/* Serialized OID's */
static const unsigned char so[7895] = {
    ...
    0x2B,0x06,0x01,0x04,0x01,0x82,0x37,0x59,0x02,0x02,0x0A,  /* [ 7839] OBJ_qteslapi */
    0x2B,0x06,0x01,0x04,0x01,0x82,0x37,0x59,0x02,0x02,0x0B,  /* [ 7850] OBJ_p256_qteslapi */
    0x2B,0x06,0x01,0x04,0x01,0x82,0x37,0x59,0x02,0x02,0x0C,  /* [ 7861] OBJ_rsa3072_qteslapi */
    0x2B,0x06,0x01,0x04,0x01,0x82,0x37,0x59,0x02,0x02,0x14,  /* [ 7872] OBJ_qteslapiii */
    0x2B,0x06,0x01,0x04,0x01,0x82,0x37,0x59,0x02,0x02,0x15,  /* [ 7883] OBJ_p384_qteslapiii */
};
...
static const ASN1_OBJECT nid_objs[NUM_NID] = {
    ...
    {"qteslapi", "qteslapi", NID_qteslapi, 11, &so[7839]},
    {"p256_qteslapi", "p256_qteslapi", NID_p256_qteslapi, 11, &so[7850]},
    {"rsa3072_qteslapi", "rsa3072_qteslapi", NID_rsa3072_qteslapi, 11, &so[7861]},
    {"qteslapiii", "qteslapiii", NID_qteslapiii, 11, &so[7872]},
    {"p384_qteslapiii", "p384_qteslapiii", NID_p384_qteslapiii, 11, &so[7883]},
};
...
static const unsigned int obj_objs[NUM_OBJ] = {
    ...
    1207,    /* OBJ_qteslapi                     1 3 6 1 4 1 311 89 2 2 10 */
    1208,    /* OBJ_p256_qteslapi                1 3 6 1 4 1 311 89 2 2 11 */
    1209,    /* OBJ_rsa3072_qteslapi             1 3 6 1 4 1 311 89 2 2 12 */
    1210,    /* OBJ_qteslapiii                   1 3 6 1 4 1 311 89 2 2 20 */
    1211,    /* OBJ_p384_qteslapiii              1 3 6 1 4 1 311 89 2 2 21 */
